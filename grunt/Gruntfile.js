				...
				files: [
					{
						...
						src: ['*.min.*'],
						dest: './../app/views/assets/external/bootstrap/css/'
					},
					...
					{
						expand: true,
						cwd: './../src/assets/external',
						src: ['**/*.*'],
						dest: './../app/views/assets/external/'
					},
					{expand: true, cwd: './../src/assets/js', src: ['*.*'], dest: './../app/views/assets/js/'},
					{
						...
						src: ['*.*'],
						dest: './../app/views/assets/external/bootstrap/fonts/'
					},
					{
						expand: true,
						cwd: './../bower_components/bootstrap/dist/js',
						src: ['*.*'],
						dest: './../app/views/assets/external/bootstrap/'
					},
					{
						expand: true,
						cwd: './../bower_components/jquery/dist',
						src: ['*.min.*'],
						dest: './../app/views/assets/external/jquery/'
					},
					{
						expand: true,
						cwd: './../bower_components/jquery-ui/',
						src: ['jquery-ui.min.js'],
						dest: './../app/views/assets/external/jquery-ui/'
					}
				]
			},
			downloads: {
