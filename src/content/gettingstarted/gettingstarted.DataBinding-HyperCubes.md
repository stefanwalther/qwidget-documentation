...
All the examples are based on the following dimensions and expressions defined for your qWidget (based on the default demo script, generated by `Ctrl+0+0` in the Script Editor)
...
### Tips and Tricks Working with the Shorthand Notation
